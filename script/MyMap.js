...
//	};
	...
	this.mapPoints_ = [
		...
		{x:450,y:50,moves:[0,2,8],crumb:'ssu',name:'Wedding'},
		...
		{x:250,y:250,moves:[0,6,7,14,17,18],crumb:'uussuu',name:'Zoologischer Garten'},
		{x:550,y:250,moves:[7,8,15],crumb:'uss',name:'Brandenburger Tor'},
		{x:750,y:250,moves:[2,4,8,12,16,21,22],crumb:'uusuuus',name:'Alexanderplatz'},
		...
		{x:550,y:300,moves:[10,16,19,28],crumb:'suus',name:'Potsdamer Platz'},
		...
		{x:550,y:450,moves:[15,24,27,35,36],crumb:'suuss',name:'Yorckstraße'},
		...
		{x:450,y:550,moves:[28,34,36],crumb:'sss',name:'Schöneberg'},
